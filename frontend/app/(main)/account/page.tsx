...
export default function AccountPage() {
    ...
    return (
      <div className="min-h-[80dvh] bg-[#fffcf8] pt-32 pb-24 lg:pt-40">
        <div className="mx-auto max-w-[1120px] px-4 sm:px-6 lg:px-10">
          <div className="h-56 animate-pulse rounded-[2rem] bg-white ring-1 ring-black/5" />
  ...
  const quickLinks = [
    { label: "Đơn hàng của tôi", description: "Theo dõi trạng thái giao hàng", href: "/orders", icon: Receipt },
    { label: "Tin nhắn với nhà hàng", description: "Trao đổi với các quán", href: "/chat", icon: ChatCircleText },
    { label: "Nhà hàng yêu thích", description: "Mở lại các quán đã lưu", href: "/account/favorites", icon: Heart },
    { label: "Giỏ hàng", description: "Kiểm tra món đang chọn", href: "/cart", icon: ShoppingCart },
    { label: "Khám phá nhà hàng", description: "Tìm thêm món ngon hôm nay", href: "/restaurants", icon: ForkKnife },
  ];
          ...
          <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-end lg:p-10">
            <div className="flex flex-col gap-6 sm:flex-row sm:items-center">
              ...
              <div className="min-w-0">
                <p className="text-xs font-black uppercase tracking-widest text-white/40">Tài khoản HungerDash</p>
                <h1 className="mt-3 truncate text-4xl font-black tracking-tight text-white sm:text-5xl">{user.username}</h1>
            ...
            <button
              ...
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-[1rem] bg-white/10 px-5 text-sm font-black text-white ring-1 ring-white/10 transition-all hover:bg-white hover:text-[#23140c] active:scale-95 sm:w-fit"
            >
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1.25fr_0.75fr]">
          <section className="rounded-[2rem] bg-white p-5 shadow-[0_20px_50px_-28px_rgba(35,20,12,0.28)] ring-1 ring-black/5 sm:p-7">
            <div className="mb-6 flex items-end justify-between gap-4">
              <div>
                ...
                <h2 className="mt-1 text-2xl font-black tracking-tight text-[#23140c]">Thông tin cá nhân</h2>
              </div>
          ...
          <aside className="space-y-6">
            <section className="rounded-[2rem] bg-white p-5 shadow-[0_20px_50px_-28px_rgba(35,20,12,0.24)] ring-1 ring-black/5 sm:p-7">
              <p className="text-xs font-black uppercase tracking-widest text-[#ff6b00]">Lối tắt</p>
              <h2 className="mt-1 text-2xl font-black tracking-tight text-[#23140c]">Hoạt động của bạn</h2>
              ...
              <div className="mt-6 space-y-3">
                {quickLinks.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <div className="grid size-11 shrink-0 place-items-center rounded-[1rem] bg-white text-[#ff6b00] ring-1 ring-black/5">
                        <Icon size={22} weight="bold" />
                      </div>
                      <div className="min-w-0 flex-1">
                        <p className="truncate text-sm font-black text-[#23140c]">{item.label}</p>
                        <p className="mt-1 truncate text-xs font-bold text-[#704322]/50">{item.description}</p>
                      </div>
                      <ArrowRight size={18} weight="bold" className="shrink-0 text-[#704322]/30 transition-transform group-hover:translate-x-1 group-hover:text-[#ff6b00]" />
                    </Link>
                  );
                })}
              </div>
            ...
            <section className="rounded-[2rem] bg-orange-50 p-5 ring-1 ring-orange-100 sm:p-7">
              <div className="mb-4 grid size-12 place-items-center rounded-[1rem] bg-white text-[#ff6b00] ring-1 ring-orange-100">
                <HouseLine size={24} weight="bold" />
              </div>
              <h2 className="text-xl font-black text-[#23140c]">Thông tin được lấy từ phiên đăng nhập</h2>
              <p className="mt-3 text-sm font-bold leading-relaxed text-[#704322]/60">
                Khi backend trả thêm avatar, số điện thoại hoặc ngày cập nhật, trang này sẽ tự hiển thị theo dữ liệu mới trong tài khoản.
              </p>
            </section>
          </aside>
        </div>
