...
export default function ManageMessagesPage() {
      ...
      try {
        ...
        if (isCurrentRequest) {
          ...
          setSelectedConversationId(
            (currentId) => currentId ?? data[0]?.id ?? null,
          );
        }
      } catch (error) {
        if (isCurrentRequest) {
          ...
          setErrorMessage(
            error instanceof ApiError
              ? error.message
              : "Không thể tải tin nhắn nhà hàng.",
          );
        }
      } finally {
        if (isCurrentRequest) {
  ...
  return (
    <div>
      ...
      <section className="grid h-[min(720px,calc(100dvh-10rem))] min-h-[560px] overflow-hidden rounded-4xl bg-white shadow-[0_20px_55px_-32px_rgba(35,20,12,0.45)] ring-1 ring-black/5 xl:grid-cols-[360px_1fr]">
        <aside className="no-scrollbar min-h-0 overflow-y-auto border-b border-[#23140c]/5 bg-[#fff7ed] p-4 xl:border-b-0 xl:border-r">
          ...
          {isLoadingConversations ? (
            ...
            <div className="rounded-3xl border border-dashed border-[#23140c]/10 bg-white px-5 py-14 text-center">
              <UserCircle
                size={44}
                weight="bold"
          ...
          {selectedConversation ? (
                ...
                {isLoadingMessages ? (
                  ...
                  <div className="flex h-full min-h-[360px] items-center justify-center text-center">
                    <div className="max-w-sm">
                      ...
                      <p className="mt-2 text-sm font-bold leading-relaxed text-[#704322]/55">
                        Gửi phản hồi đầu tiên để hỗ trợ khách.
                      </p>
                    </div>
                  </div>
                ) : (
            ...
            <div className="flex min-h-0 flex-1 items-center justify-center p-8 text-center">
              <div className="max-w-sm">
                ...
                <p className="mt-2 text-sm font-bold leading-relaxed text-[#704322]/55">
                  Hội thoại nhà hàng sẽ hiển thị khi bạn chọn một khách trong
                  danh sách.
                </p>
              </div>
            </div>
