...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(message === "Invalid email or password" ? "Email hoặc mật khẩu không đúng." : message);
    } finally {
        ...
        <div className="grid w-full gap-10 overflow-hidden rounded-[3rem] bg-white p-4 shadow-[0_40px_100px_-40px_rgba(35,20,12,0.15)] ring-1 ring-black/5 lg:grid-cols-2 lg:p-10">
          ...
          <div className="flex flex-col justify-center px-4 py-8 sm:px-12 lg:px-16">
            ...
            >
              ...
              <h1 className="text-4xl font-black tracking-tight text-[#23140c] sm:text-5xl">Chào bạn trở lại!</h1>
              ...
              <form className="mt-10 space-y-5" onSubmit={handleSubmit}>
                <div className="space-y-2">
                  <label htmlFor="login-email" className="text-sm font-black uppercase tracking-widest text-[#23140c]/40 px-1">Email</label>
              ...
              <div className="relative my-10 flex items-center justify-center">
                ...
                <span className="absolute bg-white px-4 text-sm font-bold text-[#704322]/40">Hoặc tiếp tục với</span>
              </div>
              ...
              <p className="mt-10 text-center font-bold text-[#704322]/70">
                Chưa có tài khoản?{" "}
                <Link href="/register" className="text-[#ff6b00] hover:underline">Đăng ký miễn phí</Link>
              </p>
            </motion.div>
          </div>
          ...
          <div className="relative hidden overflow-hidden rounded-[2.5rem] bg-[#ff6b00] lg:block">
            ...
            <div className="absolute bottom-10 left-10 right-10 flex flex-col gap-6">
              ...
              >
                <p className="text-xl font-black text-white">&quot;Giao hàng cực nhanh, đồ ăn vẫn còn nóng hổi khi tới tay.&quot;</p>
                <div className="mt-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-white/60">Người dùng tại Q1, HCM</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-lg font-black text-[#23140c]">Hơn 12k quán ngon</p>
                    <p className="text-sm font-bold text-[#704322]/60">Đang phục vụ ngay bây giờ</p>
                  </div>
                </div>
              </motion.div>
            </div>
